...
<div class="giiant-crud iuran-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . 'Daftar Iuran', ['index'], ['class' => 'btn btn-default']) ?>
    </p>
    ...
    <div class="box box-info">
        <div class="box-body">
            <?php $this->beginBlock('app\models\Iuran'); ?>
            ...
            Tabs::widget(
                    [
                        ...
                        'items' => [ [
                                ...
                                'content' => $this->blocks['app\models\Iuran'],
                                'active' => true,
                            ],]
                    ]
            );
