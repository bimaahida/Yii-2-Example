...
class SiteController extends Controller
{
    ...
    public function actionRequest()
    {
        ...
        try {
            if ($model->load($_POST) && $model->save()) {
                Yii::$app->session->addFlash("success", "Data berhasil dikirim untuk dicetak");
    ...
    public function actionReqskck()
    {
        $model = new \app\models\Skck();
        $model->rt = $model->getRt();
        $model->rw = $model->getRw();
        $model->tanggal_buat = date('Y-m-d');
        $model->user = 1;
        ...
        return $this->render('reqskck', ['model' => $model]);
    }
    ...
    public function actionInformasi(){
        $model1 = PapanInformasi::find()->where(['id'=>1])->one();
        $a1 = $model1->gambar;
        $b1 = $model1->caption;
        $model2 = PapanInformasi::find()->where(['id'=>2])->one();
        $a2 = $model2->gambar;
        $b2 = $model2->caption;
        $model3 = PapanInformasi::find()->where(['id'=>3])->one();
        $a3 = $model3->gambar;
        $b3 = $model3->caption;
        return $this->renderPartial('informasi', [
            'a1'=>$a1,
            'b1'=>$b1,
            'a2'=>$a2,
            'b2'=>$b2,
